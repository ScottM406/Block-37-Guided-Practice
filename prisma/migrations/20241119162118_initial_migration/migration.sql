...
-- AddForeignKey
ALTER TABLE "Reservation" ADD CONSTRAINT "Reservation_ressaurantId_fkey" FOREIGN KEY ("ressaurantId") REFERENCES "Restaurant"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
